...
def search_individual(request):
    ...
    return render(request,'classroom/teachers/search_individual.html', context = context)
...
def search_individual_details(request):
    ...
    return render(request,'classroom/teachers/search_individual_details.html', context=context)
